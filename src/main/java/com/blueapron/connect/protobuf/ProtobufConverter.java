...
public class ProtobufConverter implements Converter {
  ...
  private static final String SHOULD_OUTPUT_ENUM_NUMBERS_CONFIG = "shouldOutputEnumNumbers";
  ...
  public void configure(Map<String, ?> configs, boolean isKey) {
    ...
    boolean shouldOutputEnumNumbers = "true".equals(configs.get(SHOULD_OUTPUT_ENUM_NUMBERS_CONFIG));
    ...
    try {
      log.info("Initializing ProtobufData with args: [protoClassName={}, legacyName={}, useConnectSchemaMap={}, shouldOutputEnumNumbers={}]", protoClassNameString, legacyNameString, useConnectSchemaMap, shouldOutputEnumNumbers);
      protobufData = new ProtobufData(Class.forName(protoClassNameString).asSubclass(com.google.protobuf.GeneratedMessageV3.class), legacyNameString, useConnectSchemaMap, shouldOutputEnumNumbers);
